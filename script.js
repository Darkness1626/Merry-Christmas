...
$(document).ready(function () {
  ...
  let text =
    "Chúc cậu có một Giáng sinh vui vẻ, ấm áp, ngọt ngào và đầy ý nghĩa. Hy vọng mỗi ngày của cậu đều tràn đầy niềm vui!🎄Merry Christmas🎄!";
  ...
  const playButton = document.querySelector(".button"); // Nút có lớp 'button'
  const backgroundMusic = document.getElementById("backgroundMusic"); // Thẻ audio
